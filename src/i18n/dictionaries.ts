...
export const dictionaries: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    "open_file": "Open file",
    "loading": "Loading…",
    "merge_intro": "Drag rows by the ⋮⋮ grip, use Shuffle or manual order. Order from top down is the merged PDF.",
    ...
    "compress_intro": "Light mode keeps quality nearly unchanged. Deep rasterizes pages to JPEG — smaller scans, text may soften slightly.",
    ...
    "repair_intro": "Re-reads and saves with pdf-lib — sometimes fixes light structure issues. Not a full repair suite.",
    ...
    "pdf_jpg_intro": "Pages render through PDF.js, bundled as JPEGs in a ZIP. Higher scale ⇒ sharper/larger.",
    "pdf_jpg_pages": "Pages:",
    ...
    "office_intro": "High‑quality PDF to Word / Excel / PowerPoint needs heavy engines on a server; this app opens iLovePDF in your browser.",
    ...
    "organize_intro": "List pages in their new order (starting at 1). Duplicates auto-collapse.",
    "organize_intro_tail": "Pages you skip disappear from output (easy trimming).",
    ...
    "unlock_intro": "No password ⇒ straight re-save. With an open password we decrypt via pdf.js and rasterize pages (scan-like output).",
    ...
    "protect_intro": "Encrypting PDFs in pure browser tooling is scarce. Stripping passwords is local; tap below to guard a file via iLovePDF.",
    "protect_main_btn": "Protect PDF (iLovePDF)",
    "protect_alt_btn": "Alternate unlock via site",
    "protect_busy_dots": "…",
    "ocr_intro": "Tesseract OCR: pages rasterize before recognition. First run downloads packs (needs Internet). Try one page on huge files.",
    ...
    "history_intro": "Recent saves stay offline (≤50 rows). Compatible items reopen in Reader or Share again.",
    ...
    "reader_supported": "PDF · pictures · video · TXT · Word · Excel · PowerPoint · HTML & code",
    "reader_loading_alt": "Loading {label}…",
    "reader_prev_pdf": "Previous PDF page",
    "reader_prev": "Previous",
    "reader_next_pdf": "Next PDF page",
    "reader_next": "Next",
    "reader_swipe_hint": "Swipe ← previous · next → · Vertical scroll",
    ...
    "reader_pdf_page_swipe_arialabel": "PDF page — swipe sideways",
    "reader_plain_trunc": "\n\n… truncated — roughly {count} chars max.",
    "inbound_unsupported_open": "Opening this file type via “Open with” is not supported yet.",
    "inbound_open_fail": "Could not open",
    "home_intro_a": "On-device tools + ",
    "home_intro_b": "export history",
    "home_intro_c": ". Office conversion and Protect use a verified browser flow; parity with heavyweight desktop tooling still wants a backend.",
    ...
    "home_note_part1": "Need commercial-grade PDF→Office or queues? Plug in ",
    "home_note_part2": " or your own APIs — separate milestone.",
    ...
    "edit_intro_mid": "corner (pts). ASCII text stays vectors; Cyrillic text flattens to PNG; images JPG & PNG.",
    "edit_open": "Open PDF",
    "undo": "Undo",
    "edit_save_file": "Save",
    ...
    "err_merge_read_pdf": "Could not read \"{name}\" — try Repair PDF or pick another.",
    ...
    "unlock_need_pw_or_corrupt": "Open password missing or PDF damaged",
    "err_pdf_page_oob": "Page {page} absent (have {total})",
    "err_draw_image_formats": "Only JPG/PNG embed",
    "reader_unsupported_doc": ".doc is legacy — reopen as DOCX/PDF",
    ...
    "office_share_sheet_error": "Share couldn’t launch — upgrade the native build."
  },
  ru: {
    "aria_back": "Назад",
    ...
    "loading": "Загрузка…",
    "merge_intro": "Перетащите строки за ⋮⋮, используйте «Перемешать» или сортируйте вручную. Верх → низ задаёт порядок в объединении.",
    ...
    "toast_merge_done_share": "Готово: в «Поделиться» выберите «Сохранить» или менеджер файлов.",
    ...
    "compress_intro": "«Лёгкий» почти сохраняет качество. «Глубокий» кодирует в JPEG — архив становится заметно легче.",
    ...
    "repair_intro": "Переоткрытие и сохранение pdf-lib — иногда помогает при лёгких ошибках структуры.",
    "repair_run": "Попробовать восстановить",
    "repair_busy": "Пересохранение…",
    "toast_repair_done_share": "PDF пересохранён — откройте «Поделиться». Сильно повреждённые файлы могут не открыться.",
    ...
    "toast_split_one_share": "Один PDF готов — сохраните через «Поделиться».",
    ...
    "jpg_intro": "Изображение = одна A4‑страница, пропорции сохраняются. JPG/PNG",
    ...
    "pdf_jpg_intro": "Рендер PDF.js → JPEG‑кадры → ZIP.",
    ...
    "office_intro": "Честный экспорт PDF→Office требует тяжёлых серверных движков; здесь мы открываем проверенный iLovePDF во встроенном/системном браузере.",
    "office_word": "PDF → Word",
    "office_excel": "PDF → Excel",
    "office_ppt": "PDF → PowerPoint",
    ...
    "organize_intro": "Перечислите номера в новой последовательности от 1. Дубликаты схлопнутся автоматически.",
    "organize_intro_tail": "Не упомянутые страницы выпадут из PDF.",
    ...
    "toast_organize_done_share": "Готово — сохраните через «Поделиться». Лишние страницы убраны.",
    "toast_organize_done": "Страницы не из списка удалены",
    "toast_organize_err": "Ошибка",
    "unlock_intro": "Без пароля — просто сохранение. С паролем — расшифровка pdf.js + растеризация (как отсканированный файл).",
    ...
    "protect_intro": "Полноценное шифрование в браузере редко. Снимать локально уже можно; добавить пароль через iLovePDF.",
    "protect_main_btn": "Защитить PDF (iLovePDF)",
    "protect_alt_btn": "Запасной снять пароль на сайте",
    "protect_busy_dots": "…",
    "ocr_intro": "Локально Tesseract: первая инициализация качнет модели через интернет. Тяжёлым файлам пробуйте 1‑2 страниц.",
    ...
    "history_intro": "Недавние результаты хранятся только на устройстве (до 50). Подходящее открывается в Читалке или «Поделиться».",
    "history_clear": "Очистить всё",
    "history_empty": "Пока тихо. После любого сохранённого экспорта появится список.",
    ...
    "reader_supported": "PDF · картинки · видео · TXT · Word · Excel · PowerPoint · HTML и код",
    "reader_loading_alt": "Загружается {label}…",
    "reader_prev_pdf": "Предыдущая страница PDF",
    "reader_prev": "Назад",
    "reader_next_pdf": "Следующая страница PDF",
    "reader_next": "Вперёд",
    "reader_swipe_hint": "Свайп ← назад · вперёд → · высота страницы прокручивается",
    ...
    "reader_pdf_page_swipe_arialabel": "Страница PDF — свайп влево/вправо",
    "reader_plain_trunc": "\n\n… обрезано: файл превышает примерно {count} символов",
    "inbound_unsupported_open": "Такой файл из «Открыть с помощью» мы ещё не показываем.",
    "inbound_open_fail": "Не удалось открыть файл",
    "home_intro_a": "Локальный набор утилит + ",
    "home_intro_b": "быстрый архив сохранений",
    "home_intro_c": ". Office и блок «Защита» отправляют вас в проверенный браузер; для магии enterprise всё равно нужна своя платформа.",
    ...
    "home_note_part1": "Нужен промышленный PDF→Office и очередь файлов ",
    "home_note_part2": " или ваш backend — уже отдельный этап.",
    "home_note_link": "iLoveAPI",
    "home_privacy": "Политика конфиденциальности",
    ...
    "edit_intro_mid": " угла (пункты). Латиница векторами; кириллическое — PNG‑плашкой; JPG/PNG для карт.",
    ...
    "toast_pdf_loaded_sidebar": "PDF загружен — тулбокс справа",
    ...
    "err_merge_read_pdf": "«{name}» не читается — попробуйте «Восстановить PDF».",
    ...
    "unlock_wrong_or_corrupt": "Пароль неверен или PDF повреждён",
    "unlock_need_pw_or_corrupt": "Откройте с паролем или проверьте файл",
    "err_pdf_page_oob": "Стр. {page} не существует (всего {total})",
    "err_draw_image_formats": "Вставить можно только JPG/PNG",
    "reader_unsupported_doc": "DOC (старый Word) не поддерживается — сохраните docx/pdf",
    "reader_unsupported_ppt": "Формат PPT недоступен — используйте pptx",
    "reader_unsupported_generic": "Такую сущность читать не получится",
    "reader_kind_pdf": "PDF",
    ...
    "reader_kind_pptx": "PowerPoint",
    "reader_kind_html_file": "HTML",
    "office_share_dialog_title": "Сохраните или отправьте файл",
    "office_share_sheet_error": "Не удалось открыть системный Share"
  }
}